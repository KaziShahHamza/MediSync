...
// Provides a reusable two-column layout for authentication pages.
// Displays product information alongside the authentication form.
...
export default function AuthLayout({
  ...
  // Renders the responsive authentication layout and feature overview.
  return (
      ...
      <div className="grid lg:grid-cols-2 max-w-5xl w-full bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm">
        ...
        <div className="hidden lg:flex flex-col justify-center p-12 bg-sky-50">
          ...
          <p className="mt-5 text-slate-600 leading-relaxed">
            Keep medicines, health records, doctors, and medical documents
