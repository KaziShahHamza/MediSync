...
import { Pill, ImagePlus, Clock3, Save } from "lucide-react";
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-3 mt-3">
          {TIMES.map((time) => (
            <label
              key={time}
              className={`flex items-center justify-center gap-2 border rounded-xl px-3 py-3 cursor-pointer transition duration-150 ${dosageTimes.includes(time) ? "border-blue-600 bg-blue-50 text-blue-600" : "border-slate-200 text-slate-600 hover:border-blue-300"}`}
            >
              <input
                type="checkbox"
