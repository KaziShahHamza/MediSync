...
// Renders profile photo preview and photo-management controls.
// Handles photo selection, replacement, removal, and upload-state feedback.
...
export default function ProfilePhotoSection({
  ...
  // Renders the profile preview and available photo actions.
  return (
    <ProfileSection
      title="Profile Photo"
      description="Add a photo so your profile is easier to recognize."
    >
      {/* Profile preview and photo actions */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-6">
        ...
        <div className="space-y-3">
          {/* Photo selection and removal actions */}
          ...
          {/* Hidden file input used by the photo action button */}
          <input
            ref={fileInputRef}
            type="file"
