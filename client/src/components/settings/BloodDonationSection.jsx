...
export default function BloodDonationSection({
  ...
  const canSelectCompensation = ["yes", "willingly"].includes(
    form.bloodDonorStatus,
  );

  // Renders donor status and public contact information.
  return (
    <ProfileSection
      title="Blood Donation"
      description="Manage your blood donation availability and contact information."
    >
      {/* Donor status and contact fields */}
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-2">
            This number will be shown on the blood donors page.
          </p>
        </div>
      </div>

      {/* Last donation date and compensation preferences */}
      <div className="mt-6">
        ...
        <div className="grid sm:grid-cols-2 gap-3 max-w-xl">
          ...
          <ProfileSelect
            ...
            onChange={onChange}
            disabled={!canSelectCompensation}
          >
            <option value="">Select</option>
