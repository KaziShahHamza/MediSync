...
export default function Reports() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      // Organize report images in Cloudinary
      formData.append("folder", "MediSync/reports");
      ...
      if (!reportRes.ok) {
        throw new Error(report.message || "Failed to save report.");
      }
      ...
      try {
        const analyzeRes = await fetch(
          `${API_URL}/api/reports/${report._id}/analyze`,
          {
            method: "POST",
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        <aside className="card sticky top-24">
          <div className="flex items-center gap-3 mb-6">
            <div>
              ...
              <p className="text-sm text-slate-500">Add a new medical report</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Example: Blood Test - 2023"
                value={title}
                disabled={loading}
            ...
            <div>
              ...
              >
                ...
                <span className="text-sm text-slate-600 truncate">
                  {file ? file.name : "Choose report image"}
                </span>
            ...
            >
              ...
              {loading ? uploadStatus || "Processing..." : "Upload Report"}
            </button>
                  ...
                  <div className="flex gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-700 mt-1 leading-5">
                        This report was uploaded successfully, but its AI
