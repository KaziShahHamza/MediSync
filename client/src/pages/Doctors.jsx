    ...
    <div className="container page">
      ...
      <section className="mb-10">
        ...
        <p className="mt-3 text-slate-600">
          Manage your healthcare providers, hospitals, and appointment
          information.
        </p>
      </section>
          ...
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                {doctors.length} doctor{doctors.length === 1 ? "" : "s"} saved
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="grid gap-2">
                {designations.map((designation) => (
                  <label
                    key={designation}
                    className={`flex items-center gap-3 rounded-xl border px-4 py-3 cursor-pointer transition duration-150 ${
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-2">
                {specialties.map((item) => (
                  <label
                    key={item}
                    className={`flex items-center gap-3 rounded-xl border px-3 py-2.5 cursor-pointer transition duration-150 ${
                      form.specialty === item
                        ? "border-blue-600 bg-blue-50 text-blue-600"
                        : "border-slate-200 hover:border-blue-300"
                    }`}
