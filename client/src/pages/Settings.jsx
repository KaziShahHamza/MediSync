...
export default function Settings() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.ok) {
        /*
         * Keep the local context synchronized immediately.
         *
         * Depending on the backend response shape, `data` may contain
         * the profile directly or may contain user + profile.
         */
        if (data.profile) {
